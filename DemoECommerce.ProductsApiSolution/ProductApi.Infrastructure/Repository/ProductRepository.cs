    ...
    internal class ProductRepository(ProductDbContext context) : IProduct
    {
        public async Task<Response> CreateAsync(Product entity)
        {
            ...
            catch (Exception ex)
            {
                ...
                return new Response(false, "Error occcured  adding new product");
            }
        }
        public async Task<Response> DeleteAsync(int id)
        {
            try
            {
                ...
                await context.SaveChangesAsync();
                return new Response(true, $"Product with ID {id} is deleted successfully");
            }
            catch (Exception ex)
            {
        ...
        public async Task<Response> DeleteAsync(Product entity)
        {
            ...
            catch (Exception ex)
            {
                ...
                //display scary-free message to the client 
                return new Response(false, "Error occcured  Deleting product");
            }
        }
        ...
        public async Task<Product> FindByIdAsync(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                //display scary-free message to the client 
                throw new Exception("Error occcured  adding new product");
            }
        }
        public async Task<IEnumerable<Product>> GetAllAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                //display scary-free message to the client 
                throw new InvalidOperationException("Error occcured retrieving product");
            }
        }
        ...
        public async Task<Response> UpdateAsync(Product entity)
        {
            ...
            catch (Exception ex)
            {
                ...
                //display scary-free message to the client 
                return new Response(false, "Error occcured Updating existing product");
            }
        }
    }
}
